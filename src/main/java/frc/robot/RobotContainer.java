...
import frc.robot.subsystems.CustomDriveCommands;
...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        autoChooser.addOption("spinTestLOL", CustomDriveCommands.wheelRadiusCharacterization(drivetrain));
    ...
    private void configureBindings() {
        ...
        //Needs to be field centril angle following instead
        joystick.a().whileTrue(drivetrain.applyRequest(() -> drive.withRotationalRate(.1)
        ...
        //Only for simulation
        joystick.rightBumper().onTrue(drivetrain.runOnce(() -> drivetrain.setOperatorPerspectiveForward(drivetrain.getState().Pose.getRotation())));
